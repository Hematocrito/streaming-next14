...
var SoundComponent = /** @class */ (function (_super) {
    __extends(SoundComponent, _super);
    function SoundComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SoundComponent.prototype.componentDidMount = function () {
        var soundUrl = this.props.soundUrl;
        var audio = document.createElement('audio');
        audio.setAttribute('src', soundUrl || '/sounds/default-audio.mp3');
        audio.setAttribute('id', 'audio');
        var container = document.querySelector('.sound-player');
        if (container) {
            container.append(audio);
        }
    };
    SoundComponent.prototype.componentDidUpdate = function (prevProps) {
        var soundUrl = this.props.soundUrl;
    ...
    SoundComponent.prototype.render = function () {
